            ...
            <div key={d.id} className="food-card">
              ...
              <div className="food-card-body">
                ...
                <div className="food-card-meta">
                  ...
                  <div className="food-card-meta-item">
                    <span className="icon">📦</span> {d.quantity} {d.quantity_unit}
                  </div>
                </div>
                ...
                <div className="food-card-footer">
                  ...
                  {(user.role === 'receiver' || user.role === 'admin') && d.is_available && (
            ...
            <form onSubmit={handleRequestSubmit}>
              <div className="modal-body">
                <div className="alert alert-info">
                  <strong>{selectedDonation.title}</strong> - Max available: {selectedDonation.quantity} {selectedDonation.quantity_unit}
                </div>
                
                <div className="grid grid-cols-2 mt-4">
                  <div className="form-group">
                    <label className="form-label">Quantity Needed <span className="required">*</span></label>
                    <input type="number" min="1" max={selectedDonation.quantity} className="form-control" value={reqForm.quantity_requested} onChange={e => setReqForm({...reqForm, quantity_requested: parseInt(e.target.value)})} required />
                  </div>
                  <div className="form-group">
