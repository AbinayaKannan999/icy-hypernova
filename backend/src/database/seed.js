...
async function seed() {
  ...
  try {
    ...
    await client.query(`
      ...
      VALUES
        ($1, 'System Admin', 'abinayakannan999@gmail.com', $5, 'admin', '+91-9876543210', 'Chennai', 'Tamil Nadu', 'India', 13.0827, 80.2707, true, true),
        ($2, 'Rajesh Kumar', 'donor@foodbridge.com', $5, 'donor', '+91-9876543211', 'Chennai', 'Tamil Nadu', 'India', 13.0475, 80.2089, true, true),
        ($3, 'Priya Singh', 'volunteer@foodbridge.com', $5, 'volunteer', '+91-9876543212', 'Chennai', 'Tamil Nadu', 'India', 13.0839, 80.2825, true, true),
        ($4, 'Arun Sharma', 'receiver@foodbridge.com', $5, 'receiver', '+91-9876543213', 'Chennai', 'Tamil Nadu', 'India', 13.0405, 80.2337, true, true)
      ON CONFLICT (email) 
      DO UPDATE SET 
    ...
    logger.info('  Admin:     abinayakannan999@gmail.com / Admin123Admin123');
    logger.info('  Donor:     donor@foodbridge.com       / Admin123Admin123');
    logger.info('  Volunteer: volunteer@foodbridge.com   / Admin123Admin123');
    logger.info('  Receiver:  receiver@foodbridge.com    / Admin123Admin123');
