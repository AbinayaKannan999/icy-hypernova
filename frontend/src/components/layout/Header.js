...
const Header = ({ onMenuClick, onOpenMonitor }) => {
  const { user } = useAuth();
  ...
  return (
    <header className="header">
      ...
      <div className="header-actions">
        ...
        {/* Live Monitor Button */}
        <button 
          className="btn btn-sm pulse-animation" 
          style={{ background: 'var(--success)', color: 'white', border: 'none', padding: '4px 12px', borderRadius: '12px', fontSize: '11px', fontWeight: 800 }}
